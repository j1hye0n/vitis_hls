...
`define AUTOTB_DUT      sha3_256_hw
`define AUTOTB_DUT_INST AESL_inst_sha3_256_hw
`define AUTOTB_TOP      apatb_sha3_256_hw_top
`define AUTOTB_LAT_RESULT_FILE "sha3_256_hw.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "sha3_256_hw.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_sha3_256_hw_top
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.sha3_256_hw.autotvin_gmem.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.sha3_256_hw.autotvin_out_r.dat"
`define AUTOTB_TVIN_in_r_out_wrapc  "../tv/rtldatafile/rtl.sha3_256_hw.autotvin_in_r.dat"
`define AUTOTB_TVIN_inlen_out_wrapc  "../tv/rtldatafile/rtl.sha3_256_hw.autotvin_inlen.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.sha3_256_hw.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.sha3_256_hw.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 37274;
parameter LENGTH_gmem = 96;
parameter LENGTH_in_r = 1;
parameter LENGTH_inlen = 1;
