...
if {[file isfile sha3_256_hw.autotvin.dat]} {
	file delete -force sha3_256_hw.autotvin.dat
}

if {[file isfile sha3_256_hw.autotvout.dat]} {
	file delete -force sha3_256_hw.autotvout.dat
}
