...
// 
// ==============================================================
# 1 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c" 2
...
typedef int wchar_t;
# 7 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c" 2
...
# 8 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c" 2
# 1 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.h" 1



# 1 "/tools/xilinx/Vitis/2024.2/vcxx/lib/clang/14.0.6/include/stddef.h" 1 3
# 5 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.h" 2
# 14 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.h"
typedef struct {
  uint64_t s[25];
  unsigned int pos;
} keccak_state;
...
# 9 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c" 2
# 22 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
# 41 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
# 84 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
state_permute : for(round = 0; round < 24; round += 2) {
#pragma HLS pipeline
...
# 360 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
# 380 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
# 412 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
static void keccak_finalize(uint64_t s[25], unsigned int pos, unsigned int r, uint8_t p)
{
  s[pos/8] ^= (uint64_t)p << 8*(pos%8);
  s[r/8-1] ^= 1ULL << 63;
}
# 433 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
# 468 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
#pragma HLS loop_tripcount min=0 max=135
        uint64_t local_block[17];

        copy_to_local_loop:
        for(i = 0; i < r_words; i++) {
#pragma HLS pipeline off
#pragma HLS unroll off
            local_block[i] = load64(in + 8*i);
        }

        absorb_from_local_loop:
        for(i = 0; i < r_words; i++) {
#pragma HLS pipeline off
            s[i] ^= local_block[i];
        }
...
# 515 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
# 537 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
...
# 560 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake128_init(keccak_state *state)
{
  keccak_init(state->s);
  state->pos = 0;
}
# 575 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake128_absorb(keccak_state *state, const uint8_t *in, size_t inlen)
{
  state->pos = keccak_absorb(state->s, state->pos, 168, in, inlen);
}
# 587 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake128_finalize(keccak_state *state)
{
  keccak_finalize(state->s, state->pos, 168, 0x1F);
  state->pos = 168;
}
# 603 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake128_squeeze(uint8_t *out, size_t outlen, keccak_state *state)
{
  state->pos = keccak_squeeze(out, outlen, state->s, state->pos, 168);
}
# 617 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake128_absorb_once(keccak_state *state, const uint8_t *in, size_t inlen)
{
  keccak_absorb_once(state->s, 168, in, inlen, 0x1F);
  state->pos = 168;
}
# 635 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake128_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state *state)
{
  keccak_squeezeblocks(out, nblocks, state->s, 168);
}
# 647 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake256_init(keccak_state *state)
{
  keccak_init(state->s);
  state->pos = 0;
}
# 662 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake256_absorb(keccak_state *state, const uint8_t *in, size_t inlen)
{
  state->pos = keccak_absorb(state->s, state->pos, 136, in, inlen);
}
# 674 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake256_finalize(keccak_state *state)
{
  keccak_finalize(state->s, state->pos, 136, 0x1F);
  state->pos = 136;
}
# 690 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake256_squeeze(uint8_t *out, size_t outlen, keccak_state *state)
{
  state->pos = keccak_squeeze(out, outlen, state->s, state->pos, 136);
}
# 704 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake256_absorb_once(keccak_state *state, const uint8_t *in, size_t inlen)
{
  keccak_absorb_once(state->s, 136, in, inlen, 0x1F);
  state->pos = 136;
}
# 722 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake256_squeezeblocks(uint8_t *out, size_t nblocks, keccak_state *state)
{
  keccak_squeezeblocks(out, nblocks, state->s, 136);
}
# 737 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake128(uint8_t *out, size_t outlen, const uint8_t *in, size_t inlen)
{
  size_t nblocks;
  keccak_state state;
...
# 760 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_shake256(uint8_t *out, size_t outlen, const uint8_t *in, size_t inlen)
{
  size_t nblocks;
  keccak_state state;
...
# 782 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_sha3_256(uint8_t h[32], const uint8_t *in, size_t inlen)
{
  unsigned int i;
  uint64_t s[25];
...
# 804 "/home/hyeon/vitis_hls/workspace/sha3_opt/fips202.c"
void pqcrystals_kyber_fips202_ref_sha3_512(uint8_t h[64], const uint8_t *in, size_t inlen)
{
  unsigned int i;
  uint64_t s[25];
