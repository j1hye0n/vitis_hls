...
$(ObjDir)/sha3_256_tb.c_pre.c.tb.o : sha3_256_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling sha3_256_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sha3_256.c_pre.c.tb.o : sha3_256.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling sha3_256.c_pre.c.tb.c" $(AVE_DIR_DLOG)
...
$(ObjDir)/fips202.c_pre.c.tb.o : fips202.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling fips202.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
