...
entity sha3_256_hw_control_r_s_axi is
generic (
...
end entity sha3_256_hw_control_r_s_axi;
...
architecture behave of sha3_256_hw_control_r_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_OUT_R_DATA_0 : INTEGER := 16#10#;
    constant ADDR_OUT_R_DATA_1 : INTEGER := 16#14#;
    constant ADDR_OUT_R_CTRL   : INTEGER := 16#18#;
    constant ADDR_IN_R_DATA_0  : INTEGER := 16#1c#;
    constant ADDR_IN_R_DATA_1  : INTEGER := 16#20#;
    constant ADDR_IN_R_CTRL    : INTEGER := 16#24#;
