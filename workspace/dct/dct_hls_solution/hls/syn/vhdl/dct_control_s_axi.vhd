...
architecture behave of dct_control_s_axi is
    ...
    constant ADDR_INPUT_R_BASE  : INTEGER := 16#080#;
    constant ADDR_INPUT_R_HIGH  : INTEGER := 16#0ff#;
    ...
    -- memory signals
    signal int_input_r_address0 : UNSIGNED(4 downto 0);
    signal int_input_r_ce0     : STD_LOGIC;
    signal int_input_r_q0      : UNSIGNED(31 downto 0);
    signal int_input_r_address1 : UNSIGNED(4 downto 0);
    ...
    component dct_control_s_axi_ram is
        generic (
    ...
    end component dct_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_input_r
int_input_r : dct_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_input_r_q1);
-- int_output_r
int_output_r : dct_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_input_r_read = '0') and (int_output_r_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    -- input_r
    int_input_r_address0 <= SHIFT_RIGHT(UNSIGNED(input_r_address0), 1)(4 downto 0);
    ...
    int_input_r_address1 <= raddr(6 downto 2) when ar_hs = '1' else waddr(6 downto 2);
    ...
    -- output_r
    int_output_r_address0 <= SHIFT_RIGHT(UNSIGNED(output_r_address0), 1)(4 downto 0);
...
entity dct_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity dct_control_s_axi_ram;

architecture behave of dct_control_s_axi_ram is
