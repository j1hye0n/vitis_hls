...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dct_mac_muladd_16s_14ns_29ns_29_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dct_ama_addmuladd_18s_16s_13ns_29ns_29_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dct_ama_submuladd_18s_16s_14ns_29ns_29_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dst \
    op interface \
    ports { dst_address0 { O 6 vector } dst_ce0 { O 1 bit } dst_we0 { O 1 bit } dst_d0 { O 16 vector } dst_address1 { O 6 vector } dst_ce1 { O 1 bit } dst_we1 { O 1 bit } dst_d1 { O 16 vector } } \
} "
} else {
