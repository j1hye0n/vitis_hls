...
#define CONTROL_ADDR_INPUT_R_BASE  0x080
#define CONTROL_ADDR_INPUT_R_HIGH  0x0ff
#define CONTROL_WIDTH_INPUT_R      16
#define CONTROL_DEPTH_INPUT_R      64
#define CONTROL_ADDR_OUTPUT_R_BASE 0x100
#define CONTROL_ADDR_OUTPUT_R_HIGH 0x17f
#define CONTROL_WIDTH_OUTPUT_R     16
#define CONTROL_DEPTH_OUTPUT_R     64
