...
#(parameter
    ...
    input  wire [5:0]                    input_r_address0,
...
localparam
    ...
    ADDR_IER           = 9'h008,
    ADDR_ISR           = 9'h00c,
    ADDR_INPUT_R_BASE  = 9'h080,
    ADDR_INPUT_R_HIGH  = 9'h0ff,
    ADDR_OUTPUT_R_BASE = 9'h100,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [4:0]                    int_input_r_address0;
    wire                          int_input_r_ce0;
    wire [31:0]                   int_input_r_q0;
    wire [4:0]                    int_input_r_address1;
...
assign int_input_r_address1  = ar_hs? raddr[6:2] : waddr[6:2];
