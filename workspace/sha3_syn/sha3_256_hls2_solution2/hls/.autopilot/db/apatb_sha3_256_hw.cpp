...
// wrapc file define:
#define AUTOTB_TVIN_h "../tv/cdatafile/c.sha3_256_hw.autotvin_h.dat"
#define AUTOTB_TVOUT_h "../tv/cdatafile/c.sha3_256_hw.autotvout_h.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_h "../tv/rtldatafile/rtl.sha3_256_hw.autotvout_h.dat"
...
extern "C"
void sha3_256_hw_hw_stub_wrapper(void*, void*, hls::sim::Byte<8>);

extern "C"
void apatb_sha3_256_hw_hw(void* __xlx_apatb_param_h, void* __xlx_apatb_param_in_r, hls::sim::Byte<8> __xlx_apatb_param_inlen)
{
  ...
  port1.param = &__xlx_apatb_param_inlen;
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_h),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_h),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_h),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_h),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_h),
#else
  ...
  port2.param = { __xlx_apatb_param_h };
  port2.mname = { "h" };
  port2.nbytes = { 32 };
  ...
  try {
    ...
    sha3_256_hw_hw_stub_wrapper(__xlx_apatb_param_h, __xlx_apatb_param_in_r, __xlx_apatb_param_inlen);
