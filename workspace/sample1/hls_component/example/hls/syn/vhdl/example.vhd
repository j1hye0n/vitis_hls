...
architecture behav of example is 
    ...
    "example_example,hls_ip_2024_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7z010-clg225-1I,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.669000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=92,HLS_SYN_LUT=120,HLS_VERSION=2024_2}";
    ...
    signal add_ln10_fu_63_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    add_ln10_fu_63_p2 <= std_logic_vector(unsigned(a) + unsigned(c_i));
    ap_done <= ap_start;
    ...
    c_o <= std_logic_vector(unsigned(add_ln10_fu_63_p2) + unsigned(b));
