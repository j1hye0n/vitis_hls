; ModuleID = '/home/hyeon/workspace/sample1/hls_component/example/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_example_ir(i8* noalias nocapture nonnull readonly %a, i8* noalias nocapture nonnull readonly %b, i8* noalias nocapture nonnull %c) local_unnamed_addr #0 {
entry:
  %a_copy = alloca i8, align 512
  %b_copy = alloca i8, align 512
  %c_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %a, i8* nonnull align 512 %a_copy, i8* nonnull %b, i8* nonnull align 512 %b_copy, i8* nonnull %c, i8* nonnull align 512 %c_copy)
  call void @apatb_example_hw(i8* %a_copy, i8* %b_copy, i8* %c_copy)
  call void @copy_back(i8* %a, i8* %a_copy, i8* %b, i8* %b_copy, i8* %c, i8* %c_copy)
  ret void
}
...
declare void @apatb_example_hw(i8*, i8*, i8*)
...
declare void @example_hw_stub(i8* noalias nocapture nonnull readonly, i8* noalias nocapture nonnull readonly, i8* noalias nocapture nonnull)

define void @example_hw_stub_wrapper(i8*, i8*, i8*) #4 {
entry:
  call void @copy_out(i8* null, i8* %0, i8* null, i8* %1, i8* null, i8* %2)
  call void @example_hw_stub(i8* %0, i8* %1, i8* %2)
