...
#
# Script generated by xsim on Fri Jul 11 16:10:02 KST 2025
...
# script info
echo -e "top.sh - Script generated by export_simulation (xsim v2024.2 (64-bit)-id)\n"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb .wdb xsim.dir libdpi.so)
