...
// ==============================================================
`timescale 1ns/1ps
module sha3_256_hw_control_r_s_axi
#(parameter
...
//------------------------Parameter----------------------
localparam
    ADDR_OUT_R_DATA_0 = 6'h10,
    ADDR_OUT_R_DATA_1 = 6'h14,
    ADDR_OUT_R_CTRL   = 6'h18,
    ADDR_IN_R_DATA_0  = 6'h1c,
    ADDR_IN_R_DATA_1  = 6'h20,
    ADDR_IN_R_CTRL    = 6'h24,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
