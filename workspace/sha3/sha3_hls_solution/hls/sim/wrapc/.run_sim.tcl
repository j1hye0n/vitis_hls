...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sha3_256_hw.autotvin.dat"
	set constFileTvOut       "sha3_256_hw.autotvout.dat"
	set constFileHdlTvIn     "sha3_256_hw.autohdltvin.dat"
	set constFileHdlTvOut    "sha3_256_hw.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
