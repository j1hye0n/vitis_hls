...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sha3_256_hw.autotvin_gmem.dat"
         "c.sha3_256_hw.autotvin_out_r.dat"
         "c.sha3_256_hw.autotvin_in_r.dat"
         "c.sha3_256_hw.autotvin_inlen.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sha3_256_hw.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
