...
// wrapc file define:
#define AUTOTB_TVIN_out_r "../tv/cdatafile/c.sha3_256_hw.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.sha3_256_hw.autotvout_out_r.dat"
#define AUTOTB_TVIN_in_r "../tv/cdatafile/c.sha3_256_hw.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in_r "../tv/cdatafile/c.sha3_256_hw.autotvout_in_r.dat"
#define AUTOTB_TVIN_inlen "../tv/cdatafile/c.sha3_256_hw.autotvin_inlen.dat"
#define AUTOTB_TVOUT_inlen "../tv/cdatafile/c.sha3_256_hw.autotvout_inlen.dat"
#define AUTOTB_TVIN_gmem "../tv/cdatafile/c.sha3_256_hw.autotvin_gmem.dat"
#define AUTOTB_TVOUT_gmem "../tv/cdatafile/c.sha3_256_hw.autotvout_gmem.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem "../tv/rtldatafile/rtl.sha3_256_hw.autotvout_gmem.dat"
...
extern "C"
void sha3_256_hw_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_sha3_256_hw_hw(void* __xlx_apatb_param_out_r, void* __xlx_apatb_param_in_r, hls::sim::Byte<4> __xlx_apatb_param_inlen)
{
  ...
  port0.param = &__xlx_offset_byte_param_out_r;
  ...
  port1.param = &__xlx_offset_byte_param_in_r;
  ...
  port2.param = &__xlx_apatb_param_inlen;
  ...
  port3.param = { __xlx_apatb_param_out_r, __xlx_apatb_param_in_r };
  port3.mname = { "out_r", "in_r" };
  port3.nbytes = { 32, 64 };
  for (size_t off = 0, i = 0; i < port3.nbytes.size(); ++i) {
    port3.offset.push_back(off);
    off += hls::sim::divide_ceil(port3.nbytes[i], port3.asize);
  }
  __xlx_offset_byte_param_out_r = port3.offset[0]*1;
  __xlx_offset_byte_param_in_r = port3.offset[1]*1;
  ...
  try {
    ...
    sha3_256_hw_hw_stub_wrapper(__xlx_apatb_param_out_r, __xlx_apatb_param_in_r, __xlx_apatb_param_inlen);
