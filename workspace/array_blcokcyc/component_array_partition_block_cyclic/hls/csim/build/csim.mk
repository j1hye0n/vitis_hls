...
HLS_SOURCES = ../../../../matmul_partition_test.cpp ../../../../matmul_partition.cpp
...
$(ObjDir)/matmul_partition_test.o: ../../../../matmul_partition_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../matmul_partition_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/matmul_partition_test.d

$(ObjDir)/matmul_partition.o: ../../../../matmul_partition.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../matmul_partition.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/matmul_partition.d
