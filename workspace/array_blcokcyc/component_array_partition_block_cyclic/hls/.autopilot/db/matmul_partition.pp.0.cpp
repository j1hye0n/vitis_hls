...
# 2 "<built-in>" 2
# 1 "../matmul_partition.cpp" 2
# 19 "../matmul_partition.cpp"
# 1 "../matmul_partition.h" 1
# 20 "../matmul_partition.h"
__attribute__((sdx_kernel("matmul_partition", 0))) void matmul_partition(int* in1, int* in2, int* out_r, int dim, int rep_count);
# 20 "../matmul_partition.cpp" 2
...
__attribute__((sdx_kernel("matmul_partition", 0))) void matmul_partition(int* in1, int* in2, int* out_r, int dim, int rep_count) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=matmul_partition
# 24 "../matmul_partition.cpp"
