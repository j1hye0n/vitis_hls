set moduleName matmul_partition_Pipeline_writeC
set isTopModule 0
...
set cdfgNum 7
set C_modelName {matmul_partition_Pipeline_writeC}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict C { MEM_WIDTH 32 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 1}  }
	{ mul int 32 regular  }
	{ sext_ln91 int 62 regular  }
	{ dim int 32 regular  }
	{ C int 32 regular {array 256 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	...
	C { ap_memory {  { C_address0 mem_address 1 8 }  { C_ce0 mem_ce 1 1 }  { C_q0 mem_dout 0 32 } } }
}
