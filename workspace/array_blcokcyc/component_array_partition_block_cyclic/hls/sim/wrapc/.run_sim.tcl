...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matmul_partition.autotvin.dat"
	set constFileTvOut       "matmul_partition.autotvout.dat"
	set constFileHdlTvIn     "matmul_partition.autohdltvin.dat"
	set constFileHdlTvOut    "matmul_partition.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
