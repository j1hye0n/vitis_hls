...
extern "C"
#endif
void apatb_matmul_partition_ir(int *, int *, int *, int, int);
#ifdef __cplusplus
extern "C"
#endif
void matmul_partition_hw_stub(int *in1, int *in2, int *out_r, int dim, int rep_count){
matmul_partition(in1, in2, out_r, dim, rep_count);
return ;
}
#ifdef __cplusplus
extern "C"
...
extern "C"
#endif
void apatb_matmul_partition_sw(int *in1, int *in2, int *out_r, int dim, int rep_count){
refine_signal_handler();
apatb_matmul_partition_ir(in1, in2, out_r, dim, rep_count);
return ;
}
#endif
# 99 "/home/hyeon/workspace/array_blcokcyc/matmul_partition.cpp"
