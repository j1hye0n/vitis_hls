...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matmul_partition.autotvin_gmem.dat"
         "c.matmul_partition.autotvin_in1.dat"
         "c.matmul_partition.autotvin_in2.dat"
         "c.matmul_partition.autotvin_out_r.dat"
         "c.matmul_partition.autotvin_dim.dat"
         "c.matmul_partition.autotvin_rep_count.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matmul_partition.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
