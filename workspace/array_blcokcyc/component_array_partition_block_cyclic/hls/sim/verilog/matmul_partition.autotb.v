...
`define AUTOTB_DUT      matmul_partition
`define AUTOTB_DUT_INST AESL_inst_matmul_partition
`define AUTOTB_TOP      apatb_matmul_partition_top
`define AUTOTB_LAT_RESULT_FILE "matmul_partition.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "matmul_partition.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_matmul_partition_top
...
`define AESL_DEPTH_rep_count 1
`define AUTOTB_TVIN_gmem  "../tv/cdatafile/c.matmul_partition.autotvin_gmem.dat"
`define AUTOTB_TVIN_in1  "../tv/cdatafile/c.matmul_partition.autotvin_in1.dat"
`define AUTOTB_TVIN_in2  "../tv/cdatafile/c.matmul_partition.autotvin_in2.dat"
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.matmul_partition.autotvin_out_r.dat"
`define AUTOTB_TVIN_dim  "../tv/cdatafile/c.matmul_partition.autotvin_dim.dat"
`define AUTOTB_TVIN_rep_count  "../tv/cdatafile/c.matmul_partition.autotvin_rep_count.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.matmul_partition.autotvin_gmem.dat"
`define AUTOTB_TVIN_in1_out_wrapc  "../tv/rtldatafile/rtl.matmul_partition.autotvin_in1.dat"
`define AUTOTB_TVIN_in2_out_wrapc  "../tv/rtldatafile/rtl.matmul_partition.autotvin_in2.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.matmul_partition.autotvin_out_r.dat"
`define AUTOTB_TVIN_dim_out_wrapc  "../tv/rtldatafile/rtl.matmul_partition.autotvin_dim.dat"
`define AUTOTB_TVIN_rep_count_out_wrapc  "../tv/rtldatafile/rtl.matmul_partition.autotvin_rep_count.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.matmul_partition.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.matmul_partition.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1083;
parameter LENGTH_dim = 1;
parameter LENGTH_gmem = 768;
parameter LENGTH_in1 = 1;
parameter LENGTH_in2 = 1;
parameter LENGTH_out_r = 1;
parameter LENGTH_rep_count = 1;
...
initial begin : read_file_process_dim
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 1);
    fp = $fopen(`AUTOTB_TVIN_dim,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_dim);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_dim);
              if (ret != 1) begin
...
// The signal of port rep_count
reg [31: 0] AESL_REG_rep_count = 0;
assign rep_count = AESL_REG_rep_count;
initial begin : read_file_process_rep_count
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 1);
    fp = $fopen(`AUTOTB_TVIN_rep_count,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_rep_count);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    read_token(fp, token);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_rep_count);
              if (ret != 1) begin
                  $display("Failed to parse token!");
                $display("ERROR: Simulation using HLS TB failed.");
                  $finish;
...
reg end_rep_count;
reg [31:0] size_rep_count;
reg [31:0] size_rep_count_backup;
