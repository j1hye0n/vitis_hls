...
if {[file isfile matmul_partition.autotvin.dat]} {
	file delete -force matmul_partition.autotvin.dat
}

if {[file isfile matmul_partition.autotvout.dat]} {
	file delete -force matmul_partition.autotvout.dat
}
